...
export default function PalletLabelsPage() {
  ...
  async function fetchPallets() {
    ...
    setPallets(grouped);
    setLoading(false);
    // nothing selected by default now — user picks manually
  }
  ...
  function addManualPallet() {
    ...
    // supports single number "5", comma list "5,6,9", or range "1-100"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="print:hidden p-6 border-b bg-white sticky top-0 z-10">
        <h1 className="text-xl font-bold mb-4">Bond — Pallet Labels</h1>
        ...
        {/* Existing pallets from data (optional quick-pick) */}
        {pallets.length > 0 && (
          <div className="mb-4">
