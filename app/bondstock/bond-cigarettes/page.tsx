...
export default function CigarettesListPage() {
  ...
  async function backupToCloud(file: File) {
    ...
    const storagePath = `Cigarettes_${stamp}_${safeName}`;

    const { error: uploadError } = await supabase.storage
      .from("cigarettes-stock-list")
  ...
  function exportToExcel() {
    ...
    const link = document.createElement("a");
    link.href = url;
    link.setAttribute("download", "Cigarettes_full_list.csv");
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    URL.revokeObjectURL(url);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="print:hidden">
        <div className="flex items-center justify-between mb-1">
          <h1 className="text-xl font-bold">Bond Stock — Cigarettes / CC List</h1>
          <button
      ...
      <div className="hidden print:block mb-4">
        <h1 className="text-2xl font-bold">Bond Stock — Cigarettes / CC List</h1>
